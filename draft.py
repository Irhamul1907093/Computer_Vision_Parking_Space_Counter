"""last e video demonstration in presentation
#presentation less words,more talk

#each procedure gula je gula apply krso oigular output

#report should be more descriptive,as no chance for questions
#introduction,methodolyg,chobi die bhorle hobe na
#presentation stag e na ,normally"""
